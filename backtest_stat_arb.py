...
mnq_csv_path = os.path.join(base_dir, "data/processed/dollar_bars/1_minute/mnq_1min_2025.csv")
...
print("Loading MNQ and ES data...")
mnq = load_data(mnq_csv_path)
es = load_data(es_csv_path)

# Filter ES to match MNQ's 2025 date range
es = es[es.index.year == 2025]
...
print("\n--- STATISTICAL ARBITRAGE (MNQ vs ES) BACKTEST RESULTS (2025) ---")
