"""
HG (copper) slippage measurement — quote capture daemon (precommit 2026-06-26).

Polls TradeStation /v3/marketdata/quotes/MHGN26,MHGU26 every 5 s during
09:25-16:00 ET Mon-Fri and appends rows to data/quotes/hg_quote_capture.csv.
...
Binding symbol = front-month micro copper MHGN26; MHGU26 captured as context
...
Usage:
  nohup .venv/bin/python capture_hg_quotes.py > logs/hg_quote_capture.log 2>&1 &
...
SYMBOLS = "MHGN26,MHGU26"
OUT_PATH = Path("data/quotes/hg_quote_capture.csv")
ET = ZoneInfo("America/New_York")
POLL_SECONDS = 5
WINDOW_START = time(9, 25)
WINDOW_END = time(16, 0)
END_DATE = date(2026, 7, 8)  # hard stop; copper Jul->Sep roll
