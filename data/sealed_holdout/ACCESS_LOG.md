...
## Access — 2026-08-19 (YANK compressed-cascade holdout screening read)

| When | Prereg SHA | Script | Test | Result |
|---|---|---|---|---|
| 2026-08-19 | 445a9ba (Phase 1 verdict: fa1c866) | yank_compressed_cascade_phase1.py (`_run_cascade` against the holdout CSV directly, ad hoc invocation — no CLI flag added) | M15-sweep/M5-CHoCH/M1-FVG compressed cascade vs sealed MNQ holdout 2026-03-01→05-19, at Alex's explicit request as a faster substitute for the sealed prereg's Phase 2 (prospective-only) design. Decision context: Phase 1 (2025 training data) passed at PF=1.397, 100th pctile of N=100 random-null (median 0.912, p90 1.218). | ❌ **FAIL.** N=61 (well above N≥30), PF=0.7797, WR=41.0%, total −$3,389.00, exits 20 SL / 18 TP / 23 TIME_STOP. Below Phase 1's own null median (0.912), not just below p90 (1.218) — the in-sample edge did not transfer. **Caveat on this holdout's own condition, disclosed to Alex before running:** this file has now been accessed 33 times (32 prior + this one) across many unrelated candidates, including 7 runs under the S25 live-deployment prereg (69972c3) and 4 direct `--ml-threshold` sweeps (138cab1) for YANK itself — this is a screening read on a heavily-used dataset, not the pristine one-shot OOS test other candidates (HG, stat-arb, HCVWAP) got. Treated as a real negative signal, not a final verdict; the sealed prospective Phase 2 (2026-08-19 forward, N≥30) remains the actual gate and continues running via the systemd timer regardless of this result.
| 2026-09-15 02:30 UTC | da82cfc9fab8aa40b4b3d9072d0e8716a3068cfe | backtest script | `run --preregistration da82cfc9fab8aa40b4b3d9072d0e8716a3068cfe --mode original --ml-threshold 0.50 --out-dir /root/Silver-Bullet-ML-BMAD/.claude/worktrees/yank-revalidation-prereg/_bmad-output/revalidation_yank_frontmonth_20260915` | G0 reproduction, ML arm: 82 trades, **row-for-row identical** to 138cab1's `backtest_1year_20260615_181838.csv` → G0 PASS |
| 2026-09-15 02:30 UTC | da82cfc9fab8aa40b4b3d9072d0e8716a3068cfe | backtest script | `run --preregistration da82cfc9fab8aa40b4b3d9072d0e8716a3068cfe --mode original --ml-threshold 0.00 --out-dir /root/Silver-Bullet-ML-BMAD/.claude/worktrees/yank-revalidation-prereg/_bmad-output/revalidation_yank_frontmonth_20260915` | G0 reproduction, no-ML arm: 107 trades, **row-for-row identical** to `backtest_1year_20260615_185354.csv` → G0 PASS |
