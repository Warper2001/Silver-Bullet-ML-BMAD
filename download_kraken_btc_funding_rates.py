#!/usr/bin/env python3
"""
Download Kraken PF_XBTUSD historical funding rate proxy.
...
Output: data/kraken/PF_XBTUSD_funding_rate.csv
...
OUTPUT      = Path("data/kraken/PF_XBTUSD_funding_rate.csv")
