#!/usr/bin/env python3
"""
Download Kraken PI_XBTUSD historical funding rate proxy.
...
Output: data/kraken/PI_XBTUSD_funding_rate.csv
...
OUTPUT      = Path("data/kraken/PI_XBTUSD_funding_rate.csv")
