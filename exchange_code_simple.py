#!/usr/bin/env python3
"""
Simple authorization code exchange using standard auth (not PKCE).
This uses client_secret instead of code_verifier.
"""
...
if len(sys.argv) < 2:
    ...
    print()
    print("Usage: .venv/bin/python exchange_code_simple.py <authorization_code>")
    sys.exit(1)
...
# Exchange the authorization code for tokens (using standard auth, not PKCE)
data = {
