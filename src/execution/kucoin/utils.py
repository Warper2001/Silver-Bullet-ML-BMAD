"""
KuCoin SDK - Utility Functions

This module provides utility functions and decorators for the KuCoin SDK:
...
from src.execution.kucoin.exceptions import NetworkError, OrderError, RateLimitError
...
class RateLimitTracker:
    """
    Client-side rate limit tracker for KuCoin API.

    KuCoin uses weight-based rate limiting (NOT time-based like some exchanges).
    ...
    Example:
        tracker = RateLimitTracker(requests_per_minute=1000, requests_per_day=10000)
