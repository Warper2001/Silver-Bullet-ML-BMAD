...
ML_MODEL_PATH = Path(__file__).parent.parent.parent / "models/s26_soft_fvg_ml_model.pkl"
...
SYMBOL_SPECS: dict[str, dict] = {
    ...
    "MBTM26": {"point_value": 0.10, "tick_size": 5.0,  "contracts": 5},
}
...
def _build_strategy_config() -> StrategyConfig:
    ...
    default_yaml = Path(__file__).parent.parent.parent / "strategy_config_combine.yaml"
...
class Tier2StreamingTrader:
    def __init__(self, symbol: str = "MBTM26"):
