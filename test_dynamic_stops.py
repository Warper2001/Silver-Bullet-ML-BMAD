#!/usr/bin/env python3
"""
Test Dynamic Stop Placement - Tighter Stops for Bullish

Root cause: Bullish stops are 77% wider than bearish stops ($62 vs $35)
because swing highs are further away in uptrending 2025 market.

Solution: Use tighter multiplier for bullish trades (0.75x) vs bearish (1.5x)
"""
...
print("🔧 DYNAMIC STOP PLACEMENT TEST")
print("=" * 70)
