...
features = ['dir', 'atr', 'rvol', 'dist_ema', 'dist_macro_ema', 'hour_et', 'dow', 'bb_width', 'is_us_session']

X_train, y_train = train_df[features], train_df['target']
X_test, y_test = test_df[features], test_df['target']

print(f"Training on {len(X_train)} Crypto trades using Upgraded MNQ-Inspired Features...")
